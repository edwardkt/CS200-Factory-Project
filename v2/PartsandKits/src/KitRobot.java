...
public class KitRobot{
	...
	public void UpdateImage(Graphics2D g2) {
		...
		//if kit robot has gone to the kitting stand, go to conveyor belt
		if(bar.getX()==210&&arm.getY()==250)
		{
			xgoto = 40; ygoto = 425;
		}
		
		//if robot has arrived at conveyor belt, go back to original position
		if(bar.getX()==40&&arm.getY()==425)
		{
			xgoto = 100; ygoto = 125;
		}
