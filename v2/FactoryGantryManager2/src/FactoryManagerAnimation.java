...
public class FactoryManagerAnimation extends JPanel implements ActionListener {
	...
	Image Feeder1, Feeder2, Feeder3, Feeder4;
	...
	public FactoryManagerAnimation(GantryRobotClient client)
	{
		...
		Feeder1 = Toolkit.getDefaultToolkit().createImage("images/xmas_chimneyFeeder.fw.png");
		Feeder2 = Toolkit.getDefaultToolkit().createImage("images/xmas_chimneyFeeder.fw.png");
		Feeder3 = Toolkit.getDefaultToolkit().createImage("images/xmas_chimneyFeeder.fw.png");
		Feeder4 = Toolkit.getDefaultToolkit().createImage("images/xmas_chimneyFeeder.fw.png");
		...
		background = Toolkit.getDefaultToolkit().createImage("images/xmas_gantryClientBackground.fw.png");
		unitc= new UnitC();
	...
	public void paint(Graphics g)
	{
		...
		//g2.fill(feeder3);
		//g2.fill(feeder4);
		g.drawImage(Feeder1, 230, 150, 50, 65, null);
		g.drawImage(Feeder2, 230, 250, 50, 65, null);
		g.drawImage(Feeder3, 230, 350, 50, 65, null);
		g.drawImage(Feeder4, 230, 450, 50, 65, null);
